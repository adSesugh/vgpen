...
class DepartmentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $leaders = User::leadership();

        return view('departments.index', compact('departments', 'flag','leaders'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('departments.index', compact('department', 'flag','leaders', 'departments'));
    }
