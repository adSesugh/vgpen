                ...
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <div class="page-header-title">
                            <h4 class="m-b-10">Manage Teams</h4>
                        </div>
                        <ul class="breadcrumb">
                                ...
                                <div class="card">
                                    <div class="card-block">
                                        <div class="row">
                                            <div class="col-md-5">
                                                @if($flag === true)
                                                <form id="main" method="post" action="{{ route('teams.store') }}" novalidate>
                                                    @csrf
                                                    @include('teams.form')
                                                ...
                                                @else {!! Form::model($team, ['route' => ['teams.update', $team->id], 'method' => 'PATCH',
                                                'id' => 'main']) !!}
                                                    @include('teams.form')
                                                    <div class="form-group row">
                                                        <label class="col-sm-3"></label>
                                                        <div class="col-sm-9 text-right">
                                                            <a href="{{ route('teams.index') }}" class="btn btn-primary">Cancel</a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <a href="{{ route('teams.show', $item->id) }}" data-placement="top" data-toggle="tooltip" data-original-title="View Detail"><i class="feather icon-eye close-card"></i></a>
                                                                    <a href="{{ route('teams.edit', $item->id) }}" data-placement="top" data-toggle="tooltip" data-original-title="Edit Record"><i class="feather icon-edit close-card"></i></a>
                                                                    {!! Form::open([ 'method'=>'DELETE', 'route' => ['teams.destroy', $item->id], 'style' =>
                                                                    'display:none' ]) !!}
                                                                        {!! Form::button('<span class="glyphicon glyphicon-trash" aria-hidden="true" title="" />', array( 'type' => 'submit',
                                                                    'class' => '', ));!!}
                                                                    {!! Form::close() !!}
